...
void saxpy_golden_int32(size_t n, int32_t a, const int32_t *x, int32_t *y)
{
...
__attribute__((optimize("O3", "noinline", "no-tree-vectorize")))
void saxpy_golden_int16(size_t n, int16_t a, const int16_t *x, int16_t *y)
{
  for (size_t i = 0; i < n; i++) {
    y[i] = a * x[i] + y[i];
  }
...
__attribute__((optimize("O3", "noinline", "no-tree-vectorize")))
void saxpy_golden_int8(size_t n, int8_t a, const int8_t *x, int8_t *y)
{
  for (size_t i = 0; i < n; i++) {
    y[i] = a * x[i] + y[i];
  }
...
void saxpy_vec_int32(size_t n, int32_t a, const int32_t *__restrict x, int32_t *__restrict y)
{
  for (size_t i = 0; i < n; i++) {
    y[i] = a * x[i] + y[i];
  }
...
__attribute__((optimize("O3")))
void saxpy_vec_int16(size_t n, int16_t a, const int16_t *__restrict x, int16_t *__restrict y)
{
  for (size_t i = 0; i < n; i++) {
    y[i] = a * x[i] + y[i];
  }
...
__attribute__((optimize("O3")))
void saxpy_vec_int8(size_t n, int8_t a, const int8_t *__restrict x, int8_t *__restrict y)
{
  for (size_t i = 0; i < n; i++) {
    y[i] = a * x[i] + y[i];
  }
