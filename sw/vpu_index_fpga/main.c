...
__attribute__((optimize("O3"))) void index_vec16(uint16_t *__restrict a, uint16_t *__restrict b, uint16_t *c, int n)
{
    uint16_t idx = 0;
    for (int i = 0; i < n; ++i)
    {
...
__attribute__((optimize("O3"))) void index_vec8(uint8_t *__restrict a, uint8_t *__restrict b, uint8_t *c, int n)
{
    uint8_t idx = 0;
    for (int i = 0; i < n; ++i)
    {
...
#define DEFINE_TEST_SUITE(CONST_N)                                     \
    __attribute__((optimize("O1"))) void run_tests_##CONST_N(void)     \
    {                                                                  \
